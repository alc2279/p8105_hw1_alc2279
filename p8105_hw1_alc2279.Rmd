...
t = as.data.frame(example_df2, row.names = z, optional = TRUE)
library(plyr)
help(count)
count(example_df2, vars = example_df$z)
...
ggplot(example_df2, aes(x = y, y = x, color = z)) + geom_point()

ggplot(example_df2, aes(x = y, y = x, color = z_num)) + geom_point()

ggplot(example_df2, aes(x = y, y = x, color = z_factor)) + geom_point()
